...
const ImageSliderForegroundCenterTextHero: React.FC<HeroProps> = ({
  title,
  subtitle,
  backgroundImages,
}) => {
  ...
  return (
    <div className="relative h-[calc(3/4*100vh)] overflow-hidden">
      {/* Background Slider */}
      <div
      ...
      <div className="absolute inset-0 flex items-center justify-center text-white z-30 p-2">
